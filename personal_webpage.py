...
socials_section = dbc.Row([
    dbc.Col([
        html.A(html.I(className="bi bi-youtube text-danger text-center", style={'font-size': '20px', 'margin-right': '10px'}),
               href="https://www.youtube.com/@DatawithElom", 
               target="_blank",
        ),
        
        html.A(html.I(className="bi bi-instagram text-danger text-center", style={'font-size': '20px', 'margin-right': '10px'}),
               href="http://instagram.com/data.with.elom",
               target="_blank", 
        ),
        
        html.A(html.I(className="bi bi-linkedin text-primary text-center", style={'font-size': '20px', 'margin-right': '10px'}),
               href="http://linkedin.com/in/elom-tettey-kwamin-frm®-53029468",
               target="_blank", 
        ),
           
    ], width=12, align='center', className='justify-content-center'), 
...
profile_section =  dbc.Row([
        ...
        dbc.Col([
            ...
            html.P("Hello, I'm Elom Tettey Kwamin, a dedicated quantitative analyst with a passion for leveraging data and analytics to drive insights in the world of finance. I hold a Master's degree in Quantitative Finance and Economics, and my professional journey has led me to specialize in credit risk assessment and pricing financial products."),
            html.H3("Key Expertise", style={'font-family': 'Broadway, sans-serif'}),
            html.Ul([
                html.Li("Quantitative Finance: I bring a strong foundation in quantitative finance, ensuring a robust understanding of complex financial instruments and risk management strategies."),
                html.Li("Data Analysis and Analytics: My enthusiasm for data analysis is evident in my work. I enjoy exploring datasets, extracting meaningful information, and deriving actionable insights to inform strategic decision-making."),
                html.Li("Machine Learning in Finance: I thrive on exploring the intersection of finance and technology. I actively apply machine learning techniques to enhance financial modeling, risk assessment, and decision-making processes."),
                html.Li("Tool Development: I take pleasure in developing tools that streamline workflows and enhance efficiency. Proficient in Python and VBA, I create solutions that empower teams to achieve their goals with greater precision."),
            ]),
...
], fluid=True, style={'background-color': 'black', 'color': 'white'})
